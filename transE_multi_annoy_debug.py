...
def main(_):
    ...
    parser.add_argument("--worker", dest='n_worker', type=int, help="Evaluation worker", default=5)
                ...
                if n_iter > args.eval_after and (n_iter % args.eval_per == 0 or n_iter == args.max_iter - 1):
                    ...
                    for data_func, test_type in eval_dict:
                        ...
                        for testing_data in data_func(batch_size=args.eval_batch):
                            ...
                            evaluation_queue.put((testing_data, head_ids, tail_ids))
                            evaluation_count += 1
                        ...
                        print 'time taken for head id and tail id calc = %f' % et
