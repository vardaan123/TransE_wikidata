...
def main(_):
    ...
    with tf.Session() as session:
        ...
        with tf.device('/cpu'):
            ...
            eval_dict = zip([model.validation_data, model.testing_data, model.raw_training_data], ['VALID', 'TEST','TRAIN'])
            ...
            for data_func, test_type in eval_dict:
                ...
                f1.write(
                    "[%s] [HEAD PREDICTION] MEAN RANK: %.1f FILTERED MEAN RANK %.1f HIT@10 %.3f FILTERED HIT@10 %.3f\n" %
                ...
                f1.write(
                    "[%s] [TAIL PREDICTION] MEAN RANK: %.1f FILTERED MEAN RANK %.1f HIT@10 %.3f FILTERED HIT@10 %.3f\n" %
